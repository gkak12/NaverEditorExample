...
//	    String filePath = dftFilePath + "SE2" + File.separator + "multiupload" + File.separator;
	    ...
	    String filePath = "D:\\workspace\\NavyProject\\src\\main\\webapp\\assets\\dataAppImg\\tmp\\";
	    ...
	    sFileInfo += "&sFileURL=/assets/dataAppImg/tmp/"+realFileNm;
	    System.out.println("sFileInfo : " + sFileInfo);
	    out.println(sFileInfo.trim());
	}
%>
